---
name: autosar-software-architecture
description: Provide technical guidelines and architectural constraints for developing software components (SWCs) compliant with the AUTOSAR Classic platform, ensuring correct integration with the RTE and BSW layers.
---
