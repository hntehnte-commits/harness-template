---
name: javascript-quality-profile-specific
description: Ensure JavaScript modern packages and source scripts maintain robust error boundaries, comply with ESLint formatting rules, and utilize modern asynchronous execution standards.
---
