...
description: Translate any file provided by the user to the language they specify, while **strictly preserving** the original file's structure, formatting, and content — only the human-readable text is translated.
---
