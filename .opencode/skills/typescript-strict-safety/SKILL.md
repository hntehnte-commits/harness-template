---
name: typescript-strict-safety
description: Enforce type-safe development practices in TypeScript, eliminating the use of 'any', leveraging utility types, and implementing type guards to prevent runtime crashes.
---
