...
3. **Determine Scope**: Decide if the skill should be **Global** (placed directly under `.harness/skills/`) or **Profile-Specific** (placed under `.harness/profiles/<profile>/skills/`).
...
1. **Load Template**: Read the skill structure template from `/.harness/skills/skill-creator/assets/SKILL_TEMPLATE.md`.
...
1. **Verify Local Path**: Ensure the new file resides in `.harness/skills/` (or `.harness/profiles/<profile>/skills/`).
